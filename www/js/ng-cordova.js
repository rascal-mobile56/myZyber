...
// install   :0     cordova plugin add cordova-plugin-file-transfer
    ...
    var fileTransferObj = 
      {
        download: function (source, filePath, options, trustAllHosts) {
          ...
          ftDownload.onprogress = function (progress) {
            qd.notify(progress);
          };

          qd.promise.abort = function () {
            ftDownload.abort();
          };

          ftDownload.download(uri, filePath, qd.resolve, qd.reject, trustAllHosts, options);
        ...
        upload: function (server, filePath, options, trustAllHosts) {
          if(ftUpload === null)
            ...
            ftUpload.onprogress = function (progress) {
              qu.notify(progress);
            };

            qu.promise.abort = function () {
              ftUpload.abort();
            };

            ftUpload.upload(filePath, uri, qu.resolve, qu.reject, options, trustAllHosts);
