...
//        Context context=this.cordova.getActivity().getApplicationContext();
    ...
    public void startDownload(CordovaInterface cordova, CallbackContext callbackContext, JSONArray args) {
        ...
        String filePath = CurrentString.substring(0, CurrentString.lastIndexOf("/"));
...
//        DocumentFile pickedDir = DocumentFile.fromTreeUri(cordova.getActivity(), treeUri);
        ...
        //         File searchedFile = new File(pickedDir.getAbsolutePath() + "/"+separated[i]);
        //         if(searchedFile.exists() && searchedFile.isDirectory()){
        //             pickedDir = searchedFile;
        //         }
        //         else{
        ...
        if (filePath.length() > 1){
            File searchedFile = new File(pickedDir.getAbsolutePath() + "/" + filePath);
            if(searchedFile.exists() && searchedFile.isDirectory()){
                pickedDir = searchedFile;
            }
            else{
